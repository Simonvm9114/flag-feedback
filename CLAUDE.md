...
This project is built and supported by the Greenfield MVP Template — an AI-native development pipeline that takes a project from requirements to a working, maintainable product through a structured sequence of phases.
